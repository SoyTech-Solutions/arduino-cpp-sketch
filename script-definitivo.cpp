...
// ---- LM35
int pinoSensor = 0; // porta de escuta
...
void setup() {
    ...
    Serial.println(""); // pula linha inicial do código
}
...
void loop() {
    ...
    temperatura = valorLido * 0.488; // convertendo os dados analógicos para milivolts -> 5 volts/ 1023 = 0,0048 precisão do A/D
